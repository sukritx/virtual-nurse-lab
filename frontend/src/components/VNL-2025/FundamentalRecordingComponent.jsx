...
const FundamentalRecordingComponent = ({
    labNumber,
    title,
    subtitle,
    description,
    ...
    const onSubmit = useCallback(async () => {
        ...
        try {
            ...
            const fileName = `fundamental-${labNumber}_recording_${Date.now()}.${fileExt}`;
            ...
            const response = await axios.post(`/api/v1/vnl2025/fundamental/${labNumber}`, {
                fileName,
                totalChunks,
                language
            }, {
...
FundamentalRecordingComponent.propTypes = {
...
FundamentalRecordingComponent.defaultProps = {
    disableReadyButton: false,
};

export default FundamentalRecordingComponent;
