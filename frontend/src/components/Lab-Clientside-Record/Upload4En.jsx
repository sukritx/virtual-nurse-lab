...
const Lab4Recording = () => {
    ...
    const onSubmit = useCallback(async () => {
        ...
        try {
            ...
            const fileName = `lab4_recording_${Date.now()}.${recordedBlob.type.split('/')[1]}`;
            ...
            const response = await axios.post('/api/v1/lab-deployed/maternalchild-4-en', {
                fileName,
                totalChunks
            }, {
    ...
    return (
        <div className="bg-white min-h-screen flex flex-col items-center justify-center py-12">
            <div className="w-full max-w-2xl p-8">
                ...
                <h1 className="text-2xl font-bold mb-2 text-center text-gray-800">Lab 4: Family Planning</h1>
                <h2 className="text-lg mb-6 text-center text-gray-600">Oral Contraceptive Pills</h2>

                <div className="mb-6 p-4 bg-gray-100 rounded-lg text-sm text-gray-700">
                    <p>
                    A 30-year-old mother, 5 days after delivering her first child, wants to exclusively breastfeed for at least 6 months and is concerned about postpartum contraception while breastfeeding.
                    </p>
                </div>
                ...
                <div className="space-y-4 mb-8 text-gray-700">
                    <p>1. How would you recommend an appropriate contraceptive method for this postpartum mother? Please suggest one method.</p>
                    <p>2. If this postpartum mother is considering using progestin-only birth control pills, what advice would you give regarding the use of contraceptive pills, possible side effects, and appropriate solutions in case of missed doses?</p>
                </div>
