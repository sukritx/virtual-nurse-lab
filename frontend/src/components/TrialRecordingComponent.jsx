...
const LabRecordingComponent = ({ 
    ...
    const onSubmit = useCallback(async () => {
        ...
        try {
            ...
            const fileName = `trial-cssd-${labNumber}_recording_${Date.now()}.${recordedBlob.type.split('/')[1]}`;
            ...
            for (let chunkIndex = 0; chunkIndex < totalChunks; chunkIndex++) {
                ...
                await axios.post('/api/v1/trial-cssd/upload-chunk', formData, {
                    headers: { 
            ...
            const response = await axios.post(`/api/v1/trial-cssd/${labNumber}`, {
                fileName,
                totalChunks
            }, {
