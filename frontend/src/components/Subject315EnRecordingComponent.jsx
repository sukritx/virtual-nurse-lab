...
const LabRecordingComponent = ({ 
    ...
    const onSubmit = useCallback(async () => {
        ...
        try {
            ...
            const fileName = `lab${labNumber}_recording_${Date.now()}.${recordedBlob.type.split('/')[1]}`;
            ...
            const response = await axios.post(`/api/v1/lab-deployed/315-${labNumber}-en`, {
                fileName,
                totalChunks
            }, {
    ...
    }, [recordedBlob, token, attemptsLeft, labNumber, setAttemptsLeft]);
