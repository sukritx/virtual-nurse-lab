...
const Lab2Recording = () => {
    ...
    const onSubmit = useCallback(async () => {
        ...
        try {
            ...
            const fileName = `lab2_recording_${Date.now()}.${recordedBlob.type.split('/')[1]}`;
            ...
            const response = await axios.post('/api/v1/lab-deployed/upload-2', {
                fileName,
                totalChunks
            }, {
