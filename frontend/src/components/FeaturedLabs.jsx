  ...
  return (
      <div className="w-full max-w-6xl mt-6">
        ...
        <div className="relative">
          ...
          <div
            ref={scrollRef}
            className="flex overflow-x-auto gap-4 mt-4 pb-4 scrollbar-hide"
          >
            {labs.map((lab, index) => (
              <div
                key={index}
                className="bg-white shadow-md rounded-lg overflow-hidden w-64 flex-none"
              >
                <img
                  src={lab.image}
                  alt={lab.title}
                ...
                <div className="p-4">
                  ...
                  <p className="mt-2 text-sm text-gray-500">{lab.duration}</p>
                  <p className="mt-1 text-sm text-gray-500">{lab.level}</p>
                </div>
              </div>
            ))}
          </div>
