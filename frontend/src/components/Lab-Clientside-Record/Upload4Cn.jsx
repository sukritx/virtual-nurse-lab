...
const Lab4Recording = () => {
    ...
    const onSubmit = useCallback(async () => {
        ...
        try {
            ...
            const response = await axios.post('/api/v1/lab-deployed/maternalchild-4-cn', {
                fileName,
                totalChunks
            }, {
    ...
    return (
        <div className="bg-white min-h-screen flex flex-col items-center justify-center py-12">
            <div className="w-full max-w-2xl p-8">
                ...
                <h1 className="text-2xl font-bold mb-2 text-center text-gray-800">实验 4：计划生育</h1>
                <h2 className="text-lg mb-6 text-center text-gray-600">服避孕药</h2>

                <div className="mb-6 p-4 bg-gray-100 rounded-lg text-sm text-gray-700">
                    <p>
                    30岁母亲，产后5天，计划至少母乳喂养6个月，并对哺乳期内的避孕问题感到担忧。
                    </p>
                </div>
                ...
                <div className="space-y-4 mb-8 text-gray-700">
                    <p>1. 您会如何建议这位产后母亲选择适合的避孕方法？请推荐一种方法</p>
                    <p>2. 如果这位产后母亲正在考虑使用仅含孕激素的口服避孕药，您会如何提供建议？请说明如何使用此类避孕药、可能出现的副作用以及忘记服药后的解决方法。</p>
                </div>
