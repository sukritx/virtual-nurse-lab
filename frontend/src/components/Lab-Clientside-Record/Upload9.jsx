...
const Lab9Recording = () => {
    ...
    const onSubmit = useCallback(async () => {
        ...
        try {
            ...
            const fileName = `lab9_recording_${Date.now()}.${recordedBlob.type.split('/')[1]}`;
            ...
            const response = await axios.post('/api/v1/lab-deployed/upload-9', {
                fileName,
                totalChunks
            }, {
    ...
    return (
        <div className="bg-white min-h-screen flex flex-col items-center justify-center py-12">
            <div className="w-full max-w-2xl p-8">
                ...
                <h1 className="text-2xl font-bold mb-2 text-center text-gray-800">Lab 9: การส่งเสริมพัฒนาการทารก</h1>
