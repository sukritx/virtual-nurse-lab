...
const Lab5Recording = () => {
    ...
    const onSubmit = useCallback(async () => {
        ...
        try {
            ...
            const fileName = `lab5_recording_${Date.now()}.${recordedBlob.type.split('/')[1]}`;
            ...
            const response = await axios.post('/api/v1/lab-deployed/upload-5', {
                fileName,
                totalChunks
            }, {
    ...
    return (
        <div className="bg-white min-h-screen flex flex-col items-center justify-center py-12">
            <div className="w-full max-w-2xl p-8">
                ...
                <h1 className="text-2xl font-bold mb-2 text-center text-gray-800">Lab 5: การวางแผนครอบครัว</h1>
                <h2 className="text-lg mb-6 text-center text-gray-600">ยาฝังคุมกำเนิด</h2>

                <div className="mb-6 p-4 bg-gray-100 rounded-lg text-sm text-gray-700">
                    <p>
                    มารดาหลังคลอดอายุ 17 ปี สามีอายุ 18 ปี ปัจจุบันทั้งคู่กำลังเรียน ปวช. ประจำเดือนมาไม่สม่ำเสมอ การตั้งครรภ์ครั้งนี้ไม่ได้วางแผน ก่อนตั้งครรภ์คุมกำเนิดโดยการหลั่งภายนอก และรับประทานยาคุมกำเนิดแต่มักจะลืมรับประทาน หลังคลอดตั้งใจเลี้ยงบุตรด้วยนมมารดา และจะต้องกลับไปเรียนหนังสือเมื่อครบ 3 เดือนหลังคลอด
                    </p>
                </div>
