...
const LabRecordingComponent = ({
    ...
    const onSubmit = useCallback(async () => {
        ...
        try {
            ...
            const fileName = `medical-${labNumber}_recording_${Date.now()}.${recordedBlob.type.split('/')[1]}`;
            ...
            const response = await axios.post(`/api/v1/vnl2025/medical/${labNumber}`, {
                fileName,
                totalChunks
            }, {
