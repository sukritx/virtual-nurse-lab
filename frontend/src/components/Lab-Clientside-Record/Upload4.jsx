...
const Lab4Recording = () => {
    ...
    const onSubmit = useCallback(async () => {
        ...
        try {
            ...
            const response = await axios.post('/api/v1/lab-deployed/upload-4', {
                fileName,
                totalChunks
            }, {
        ...
        <div className="bg-white min-h-screen flex flex-col items-center justify-center py-12">
            <div className="w-full max-w-2xl p-8">
                ...
                <div className="mb-6 p-4 bg-gray-100 rounded-lg text-sm text-gray-700">
                    <p>
                    มารดาอายุ 30 ปี หลังคลอดบุตรคนแรกได้ 5 วัน ต้องการเลี้ยงลูกด้วยนมแม่อย่างเดียวอย่างน้อย 6 เดือน และมีความกังวลเกี่ยวกับการคุมกำเนิดหลังคลอดขณะให้นมบุตร
                    </p>
                </div>
