...
const FundamentalLabDetails = () => {
  ...
  const fetchLabDetails = async () => {
    try {
      const response = await axios.get(`/api/v1/professor/student/${userId}/lab/fundamental/${labNumber}`, {
        headers: {
...
export default FundamentalLabDetails;
