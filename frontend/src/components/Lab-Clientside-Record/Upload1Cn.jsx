...
const Lab1Recording = () => {
    ...
    const onSubmit = useCallback(async () => {
        ...
        try {
            ...
            const response = await axios.post('/api/v1/lab-deployed/upload-1-cn', {
                fileName,
                totalChunks
            }, {
                headers: { 'Authorization': `Bearer ${token}` }
    ...
    const handleLanguageChange = (event) => {
        ...
        // For Chinese, we stay on the current page
    };
        ...
        <div className="bg-white min-h-screen flex flex-col items-center justify-center py-12">
            <div className="w-full max-w-2xl p-8">
                ...
                <div className="space-y-4 mb-8 text-gray-700">
                    <p>1. 可以考虑提供有关正确含乳哺乳的技术指导及解决她担忧的策略。</p>
                    <p>2. 您将如何演示正确的哺乳姿势和技术，以防止这位母亲的乳头疼痛？</p>
                </div>
