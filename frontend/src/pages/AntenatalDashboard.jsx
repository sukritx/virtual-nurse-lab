...
const AntenatalDashboard = () => {
  ...
  const fetchLabs = async () => {
    try {
      ...
      setLabs(response.data.labs.filter(lab => lab.labInfo.labNumber >= 11 && lab.labInfo.labNumber <= 15));
    } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      <div className="container mx-auto py-10">
        ...
        <h1 className="text-3xl font-bold mb-6 text-center">Antenatal Labs</h1>
