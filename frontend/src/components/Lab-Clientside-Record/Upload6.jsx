...
const Lab6Recording = () => {
    ...
    const onSubmit = useCallback(async () => {
        ...
        try {
            ...
            const fileName = `lab6_recording_${Date.now()}.${recordedBlob.type.split('/')[1]}`;
            ...
            const response = await axios.post('/api/v1/lab-deployed/upload-6', {
                fileName,
                totalChunks
            }, {
    ...
    return (
        <div className="bg-white min-h-screen flex flex-col items-center justify-center py-12">
            <div className="w-full max-w-2xl p-8">
                ...
                <h1 className="text-2xl font-bold mb-2 text-center text-gray-800">Lab 6: การทำความสะอาดแผลฝีเย็บ</h1>

                <div className="mb-6 rounded-3xl overflow-hidden border-4 border-purple-900 shadow-lg">
                    <video 
                        controls 
                        className="w-full"
                        src="/questionVideos/situation6.mp4"
                    >
                ...
                <div className="space-y-4 mb-8 text-gray-700">
                    <p>ท่านจะให้คำแนะนำวิธีการทำความสะอาดแผลผีเย็บและเปลี่ยนผ้าอนามัยแก่มารดารายนี้อย่างไร (ครอบคลุมในประเด็น วิธีการเปลี่ยนผ้าอนามัย การทำความสะอาดแผลฝีเย็บ และการสังเกตความผิดปกติของแผลฝีเย็บ)</p>
                </div>
